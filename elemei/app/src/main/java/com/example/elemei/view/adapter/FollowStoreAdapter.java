 ...
 */
public class FollowStoreAdapter extends BaseQuickAdapter<Store, BaseViewHolder> {
    public FollowStoreAdapter(int layoutResId, @Nullable List<Store> data) {
    ...
    public FollowStoreAdapter(List<Store> data) {
